...
1. **Dushimire Aine** - Smart contract (aiken developer)
2. **Irasubiza Divine** - Backend/ API Developer (Nodejs)
3. **Ishara Gold** - Frontend/UI Developer (React)
4. **Izere Louise** - Designer
5. **Munezero Impano Christella** - Integrator
